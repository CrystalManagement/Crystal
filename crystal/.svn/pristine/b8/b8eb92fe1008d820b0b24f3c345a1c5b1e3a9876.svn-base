...
public class UserManageController {
	...
	public ModelAndView add(String id) throws Throwable {
		...
		model.addObject("allroles", serviceR.all());
		if (id != null) {// 修改
			model.addObject("user", service.getUserById(id));
			//model.addObject("roles", serviceR.of(id));
		}
		return model;
	}
	...
	@Transactional
	public ModelAndView doAdd(UserVO user, Integer[] roleId) throws Throwable {
...
//		serviceR.setRole(user.getId(), roleId);
		return model;
	}
