package com.base.handler.service;
...
import com.base.common.util.MessageUtil;
import com.base.weather.domain.CityWeather;
import com.base.weixin.message.WeixinMessageUtil;
import com.base.weixin.message.WeixinRequest;
import com.base.weixin.message.WeixinTextResponse;
...
public class VoiceMessageHandlerServiceImp implements MessageHandlerService {
	...
	public String processMsg(WeixinRequest request) throws Throwable {
		...
		if (request.getRecognition() != null) {
			...
			String tianqi = ConfigUtil.getValue("tianqi");
