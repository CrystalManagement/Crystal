...
public class WeixinApi {
	...
	public static Result createMenu(Menu menu) throws IOException {
		...
		String jsonResult = HttpUtil.sendHttpReq(String.format(POST_MENU, token.getAccess_token()), POST,
				jsonRequet, CHARSET);
		System.out.println(jsonResult);
	...
	public static MenuResult getMenu() throws IOException {
		AccessToken token = getAccessToken();
		String jsonResult = HttpUtil.sendHttpReq(String.format(GET_MENU, token.getAccess_token()), GET,
				null, CHARSET);
		System.out.println(jsonResult);
	...
	public static QRTicket getQrTicket(QRTicketRequest request) throws Exception {
		...
		String jsonResult = HttpUtil.sendHttpReq(String.format(POST_QRTICKET, token.getAccess_token()), POST,
				jsonRequest, CHARSET);
		System.out.println(jsonResult);
	...
	public static void sendCustomMessage(CustomMessage message) throws Exception {
		...
		System.out.println(jsonRequet);
		String jsonResult = HttpUtil.sendHttpReq(String.format(POST_CUSTOMMSG, token.getAccess_token()), POST,
				jsonRequet, CHARSET);
		System.out.println(jsonResult);
	}
